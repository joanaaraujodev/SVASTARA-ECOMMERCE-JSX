...
import { FavsContextType } from "./localStorage";
...
function ProductCard({
  ...
  const calculateTotal = (onePrice: string | number, quantity: number) => {
    ...
    >
      {addToFavs ? (
        ...
        <img
          onClick={(e) => {
            e.stopPropagation();
            toggleFav({ id: productId, title, img, price, category });
          }}
          src={fav}
          alt="fav"
          className={`${className}__favbutton ${
